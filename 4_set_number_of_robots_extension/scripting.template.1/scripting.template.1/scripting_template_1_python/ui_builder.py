...
from isaacsim.gui.components.element_wrappers import CollapsableFrame, StateButton, IntField, FloatField
...
class UIBuilder:
    ...
    def build_ui(self):
        ...
        with world_controls_frame:
            with ui.VStack(style=get_style(), spacing=5, height=0):
                _num_btn = IntField(label="Number of Robots")
                _num_btn.set_lower_limit(0)
                _num_btn.set_on_value_changed_fn(
                    lambda value: self._get_robotnum(value)
                )
    ...
    def _setup_scene(self):
        ...
        loaded_objects = self._scenario.load_example_assets(self._robot_num)
        print(self._robot_num)

        # Add user-loaded objects to the World
        self.world = World.instance()
        for loaded_object in loaded_objects:
            self.world.scene.add(loaded_object)
    ...
    def _setup_scenario(self):
        ...
        """
        self._scenario.setup(self._robot_num)
    ...
    def _get_robotnum(self, num):
        self._robot_num = num

    def _get_velocity(self, num):
        self._robot_velocity = num