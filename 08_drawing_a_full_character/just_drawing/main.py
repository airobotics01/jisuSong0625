...
def main():
    ...
    # 초기화
    # character_name = "융"  # 그릴 한글 문자
    # character_name = "합"  # 그릴 한글 문자
    # character_name = "프"  # 그릴 한글 문자
    # character_name = "로"  # 그릴 한글 문자
    # character_name = "젝"  # 그릴 한글 문자
    # character_name = "트"  # 그릴 한글 문자
    # character_name = "공"  # 그릴 한글 문자
    # character_name = "모"  # 그릴 한글 문자
    character_name = "전"  # 그릴 한글 문자
